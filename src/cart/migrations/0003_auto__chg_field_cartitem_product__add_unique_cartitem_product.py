...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cart_cartitem', 'product_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['products.Product'], unique=True))
        # Adding unique constraint on 'CartItem', fields ['product']
        db.create_unique(u'cart_cartitem', ['product_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CartItem', fields ['product']
        db.delete_unique(u'cart_cartitem', ['product_id'])


        # Changing field 'CartItem.product'
        db.alter_column(u'cart_cartitem', 'product_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['products.Product']))
