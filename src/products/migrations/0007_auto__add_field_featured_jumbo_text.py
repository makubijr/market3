...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Featured.jumbo_text'
        db.add_column(u'products_featured', 'jumbo_text',
                      self.gf('django.db.models.fields.CharField')(max_length=3000, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Featured.jumbo_text'
        db.delete_column(u'products_featured', 'jumbo_text')
